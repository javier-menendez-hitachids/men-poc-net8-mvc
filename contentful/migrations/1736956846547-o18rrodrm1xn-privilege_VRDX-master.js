function migrationFunction(migration, context) {
    ...
    migration.deleteContentType("privCredentials")
    migration.deleteContentType("eComShoppingExpressModel")
    migration.deleteContentType("privilegePersonalData")
    migration.deleteContentType("privilegeProfilePage")
    migration.deleteContentType("eComTimetable")
    migration.deleteContentType("promotionCode")
    migration.deleteContentType("villageSelection")
    migration.deleteContentType("eComVisitVillageForm")
    migration.deleteContentType("privilegeContactPreferences")
    migration.deleteContentType("privilegeConsentPage")
    migration.deleteContentType("privilegeDashboardPage")
    migration.deleteContentType("privilegeShowCode")
    migration.deleteContentType("privilegeRegisterPage")
    migration.deleteContentType("privilegeRegisterSuccess")
    migration.deleteContentType("eComTravellingOptions")
    migration.deleteContentType("privilegeConfirmPassword")
    migration.deleteContentType("privilegeForgotPasswordPage")
    migration.deleteContentType("privilegeSigninPage")
    migration.deleteContentType("privilegeOr")
    migration.deleteContentType("privEmail")
}
